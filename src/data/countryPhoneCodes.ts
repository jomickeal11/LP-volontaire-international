...
export const FREQUENT_COUNTRIES: CountryPhoneCode[] = [
...
export const ALL_COUNTRY_CODES: CountryPhoneCode[] = [
  ...
  { name: "Congo-Kinshasa (RDC)", code: "CD", dial: "+243" },
