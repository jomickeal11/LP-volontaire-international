...
export default function AdminArticles() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    if (!formData.titleFr.trim() || !formData.excerptFr.trim() || !formData.contentFr.trim()) {
      setError("Le titre, le résumé et le contenu en français sont obligatoires.")
      return
    }
  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      {/* ── Create Article Modal avec Onglets Multilingues & Sélecteur Image ── */}
      {modalOpen && (
        <div
