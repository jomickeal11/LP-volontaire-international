...
const translations = {
  EN: {
    ...
    agbelouve: {
      ...
      facts: [
        ...
        { label: "Living Conditions", value: "Arrangements to be confirmed" },
      ],
    },
    support: {
      tag: "Your Support",
      ...
      items: [
        { label: "Accommodation", value: "Subject to programme" },
        { label: "Meals", value: "Local arrangements" },
        { label: "Transport", value: "Arrangements to be confirmed" },
    ...
    apply: {
      ...
      errors: {
        ...
        educationReq: 'Please specify your education / qualifications.',
        fieldReq: 'Please specify your field of study.',
  ...
  FR: {
    ...
    apply: {
      ...
      errors: {
        ...
        educationReq: 'Veuillez renseigner votre formation.',
        fieldReq: 'Veuillez renseigner votre domaine d\'études.',
    ...
    agbelouve: {
      ...
      facts: [
        ...
        { label: "Conditions de vie", value: "Modalités à préciser selon le programme" },
      ],
    },
    support: {
      tag: "Votre soutien",
      ...
      statusVariable: "Variable",
      items: [
        { label: "Logement", value: "À préciser selon le programme" },
        { label: "Repas", value: "Arrangements locaux" },
        { label: "Transport", value: "Modalités à préciser selon le programme" },
  ...
  DE: {
    ...
    support: {
      ...
      items: [
        { label: "Unterkunft", value: "Gemäß Programm zu klären" },
        { label: "Verpflegung", value: "Lokale Vereinbarungen" },
        { label: "Transport", value: "Details werden mitgeteilt" },
    ...
    apply: {
      ...
      errors: {
        ...
        educationReq: 'Bitte geben Sie Ihren Bildungsabschluss an.',
        fieldReq: 'Bitte geben Sie Ihr Studienfach an.',
